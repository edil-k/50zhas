...
function t_forms__removePlaceholder(t) {
    ...
    if ("INPUT" === e.tagName) {
        var r = e.closest("[data-input-lid]"), o = e.getAttribute("placeholder"), a = "";
        if (r) a = r.getAttribute("data-input-lid"); else {
...
function t_forms__moveToErrorInput(t, e) {
    var r = function (e) {
        var r;
        e.preventDefault(), document.getElementById(t).focus()
    };
    ...
    if (t || !document.body.classList.contains("t706__body_cartwinshowed") && !document.body.classList.contains("t706__body_cartpageshowed") || (e = document.querySelector(".t706")), e) {
        ...
        if (r) {
            ...
            if (r.classList.contains("t-form__inputsbox_inrow") || (o = e.querySelectorAll(".t-input-block_width")), 0 !== o.length) {
                ...
                var a = r.offsetWidth, n = ["rd", "ri", "uc", "ws", "hd", "fr", "st"];
                Array.prototype.forEach.call(o, (function (t) {
                    if (r.classList.contains("t-form__inputsbox_inrow") || (t = t.closest(".t-input-group")), t && t.classList.contains("t-input-group_inrow-withsibling")) {
                        var e = t.nextElementSibling, o = n.filter((function (t) {
    ...
    t_forms__createArrWithAllRows(t, "t-input-group_inrow").forEach((function (t) {
        ...
        if (t.forEach((function (t) {
            ...
            var r = t.reduce((function (t, e) {
                ...
                return -1 !== (o = o[0]).indexOf("100") && (a = 3), t + Number(o.substr(o.length - 2, a))
            }), 0);
...
function t_forms__calculateFieldsWidthInJS(t, e) {
    ...
    for (var a in o) if (t.classList.contains(o[a])) {
        t.style.width = (e - 15 * (a - 1)) / a + "px";
        var n = t.previousElementSibling;
        n && n.classList.contains("t-input-title") && (n.style.width = (e - 15 * (a - 1)) / a + "px"), window.innerWidth < 480 && (t && (t.style.width = "100%"), n && (n.style.width = "100%"))
    }
}
        ...
        if (o) {
            ...
            if (r.tildaSendingStatus && (i = r.tildaSendingStatus), !(i && i >= 1 || t_hasClass(r, "t706__submit_disable"))) {
                ...
                var s, l = document.getElementById("allrecords").getAttribute("data-tilda-formskey"),
                    c = parseInt(o.getAttribute("data-formactiontype")), d;
                if (!o.querySelectorAll(".js-formaction-services").length && 1 !== c && !l) {
                    var u = t_forms__getErrorContainers(o, ""), m = u.errorBoxes, p = u.allError;
                ...
                if (o.querySelector(".g-recaptcha") && grecaptcha) {
                    window.tildaForm.currentFormProccessing = {form: o, btn: r, formtype: c, formskey: l};
                    var f = o.tildaCaptchaClientId;
                    if (f) grecaptcha.reset(f); else {
                        var _ = {
                            size: "invisible",
    ...
    Array.prototype.forEach.call(t, (function (t) {
        ...
        if (e) {
            ...
            if (!window.tildaForm.isRecaptchaScriptInit) {
                var o = document.head, a = document.createElement("script");
...
function t_forms__getMsg(t) {
    ...
    return e.EN = {
        ...
        req: "Толықтай толтырылмады",
        reqfield: "Есіміңізді толтырыңыз",
...
function t_forms__onSuccess(t) {
    ...
    var e = t.closest(".r"), r = e.getAttribute("data-record-type"), o = t.querySelector(".t-form__inputsbox"),
        a = getComputedStyle(o, null), n = parseInt(a.paddingTop) || 0, i = parseInt(a.paddingBottom) || 0, s, l,
        c = o.clientHeight - (n + i) + (o.getBoundingClientRect().top + window.pageYOffset),
        d = t.querySelector(".t-form__successbox"), u = d ? d.getBoundingClientRect().top + window.pageYOffset : 0,
        m = 0, p = window.innerHeight, f = document.body, _ = document.documentElement,
        w = Math.max(f.scrollHeight, f.offsetHeight, _.clientHeight, _.scrollHeight, _.offsetHeight);
    if (121 == r) {
        var y = t.getAttribute("data-success-callback");
        y && (r = y.split("_onSuccess")[0].replace("t", ""))
    }
    var h = "t" + r + "__inputsbox_hidden", g = [702, 708, 862, 945, 1014, 1114], v = !0;
    m = window.innerWidth > 960 ? u - 200 : u - 100;
    var b = document.querySelector(".t-tildalabel");
    if (u > window.scrollY || w - c < p - 100) o.classList.add(h), p > w && b && setTimeout((function () {
        t_fadeOut(b)
    }), 300); else {
        for (var E = 0; E < g.length; E++) if (g[E] == r) {
            v = !1;
            break
        }
    ...
    if (x && setTimeout((function () {
        ...
        var F = e.querySelector(".t" + r + "__btn_prev"), A = e.querySelector(".t" + r + "__wrapper"),
            S = e.querySelector(".t" + r + "__quiz-form-wrapper");
        F && (F.style.display = "none"), A && (A.style.minHeight = ""), S && (S.style.minHeight = "")
    }
}
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
    ...
    t_forms__initForms();
    var o = !!document.querySelector(".t706"), a = !!document.querySelector(".js-payment-systembox"),
    ...
    for (var e = t.querySelectorAll(".js-tilda-rule"), r = [], o = !0, a = 0; a < e.length; a++) {
        ...
        if (!(i && "true" === i.getAttribute("data-hidden-by-condition") || s && "true" === s.getAttribute("data-hidden-by-condition"))) {
            var c = !!parseInt(n.getAttribute("data-tilda-req") || 0, 10),
                d = n.getAttribute("data-tilda-rule") || "none", u = "", m = "",
                p = n.getAttribute("data-tilda-rule-minlength") || 0,
                f = n.getAttribute("data-tilda-rule-maxlength") || 0, _ = {}, w = n.value, y = "",
                h = n.getAttribute("type"), g = n.getAttribute("name"), v = t.getAttribute("data-formcart");
            _.obj = n, _.type = [], w && w.length && (y = w.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), w = w.trim()), w.length > 0 && (o = !1), p && (p = parseInt(p, 10)), f && (f = parseInt(f, 10));
            var b = !w.length && !y.length, E = "checkbox" === h || "radio" === h,
                x = !t.querySelectorAll('[name="' + g + '"]:checked').length;
            if (c && (b || E && x)) _.type.push("req"); else {
                switch (d) {
                    case"email":
                    ...
                    case"date":
                        ...
                        y.length > 0 && !y.match(S[n.getAttribute("data-tilda-dateformat")] || /^[0-9]{1,4}[\-\.\/][0-9]{1,2}[\-\.\/][0-9]{1,4}$/gi) && _.type.push("date");
                        break;
                    case"time":
                        u = /^[0-9]{2}[:\.][0-9]{2}$/gi, y.length > 0 && !y.match(u) && _.type.push("time");
                        break;
                    case"name":
    ...
    if ("y" === v) {
        var L = window.tcart_minorder > 0, C = window.tcart_mincntorder > 0, T, _, _;
        if (L) if ((window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : window.tcart.prodamount) < window.tcart_minorder) (_ = {
            obj: {},
            type: []
        }).type.push("minorder"), r.push(_);
        if (C && window.tcart.total < window.tcart_mincntorder) (_ = {
            obj: {},
            type: []
        }).type.push("minquantity"), r.push(_)
    }
    return o && !r.length && (r = [{obj: "none", type: ["emptyfill"]}]), r
}, window.tildaForm.hideErrors = function (t) {
    if ("object" != typeof t || t.length) {
        t instanceof Element || (t = t[0]);
        var e = t.querySelectorAll(".js-errorbox-all"), r = t.querySelectorAll(".js-rule-error"),
            o = t.querySelectorAll(".js-error-rule-all"), a = t.querySelectorAll(".js-successbox"),
    ...
    var r = t.getAttribute("id"), o = t.getAttribute("data-inputbox");
    o || (o = ".blockinput");
    var a = "", n = !1, i = !0, s = "", l = "", c = "", d = "", u = document.getElementById("tilda-popup-for-error");
    ...
    if (d) {
        ...
        if (Array.prototype.forEach.call(y, (function (t) {
            ...
            if (h && h.length) {
                var g, v = '.t1093 .t-popup[data-tooltip-hook="' + h[h.length - 1] + '"]',
                    b = document.querySelector(v), E = b ? getComputedStyle(b).zIndex : 0, x = 1e4;
    ...
    if (window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout((function () {
        ...
        var A = t.closest(".r"), S = "focus";
        document.addEventListener || (S = "focusin"), t_removeEventListener(A, S, F), t_addEventListener(A, S, F, !0), t_removeEventListener(A, "change", F), t_addEventListener(A, "change", F, !0)
    }
    ...
    r || (r = ".blockinput");
    for (var o = "", a = !1, n = !0, i = "", s = "", l = "", c = [], d = 0; d < e.length; d++) if (e[d] && e[d].obj) {
        if (0 === d && "none" === e[d].obj) {
            i = t.querySelectorAll(".js-rule-error-all");
            for (var u = 0; u < i.length; u++) {
                i[u].innerHTML = '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg("emptyfill") + "</a>", i[u].style.display = "block";
                var m = t.querySelectorAll(".t-input")[0], p;
                if (m) t_forms__moveToErrorInput(m.getAttribute("id"), i[0])
            }
            break
        }
        var f = e[d].obj;
        f instanceof Element || (f = f[0]), f && (o = f.closest(r)), o && (s = o.querySelectorAll(".t-input-error"), t_addClass(o, "js-error-control-box"), s.length > 0 && (a = !0));
        for (var u = 0; u < e[d].type.length; u++) {
            var _ = e[d].type[u], w = e[d].obj.id;
            if (l = "", (i = t.querySelectorAll(".js-rule-error-" + _)).length) for (var y = 0; y < i.length; y++) {
                var h;
                (h = i[y]).getAttribute("data-rule-filled") ? h.style.display = "block" : (h.textContent && h.innerText || !t_forms__getMsg(_) ? l = i[0].textContent || i[0].innerText : h.innerHTML = '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg(_) + "</a>", h.style.display = "block", -1 === c.indexOf(_) && t_forms__moveToErrorInput(w, h), c.push(_))
            } else if (t_forms__getMsg(_) && (i = t.querySelectorAll(".js-rule-error-all")).length) for (var y = 0; y < i.length; y++) {
                var h;
                (h = i[y]).innerHTML = '<a href="#" class="t-form__errorbox-link">' + t_forms__getMsg(_) + "</a>", h.style.display = "block", -1 === c.indexOf(_) && t_forms__moveToErrorInput(w, h), c.push(_)
            }
            a && (!l && t_forms__getMsg(_ + "field") ? l = t_forms__getMsg(_ + "field") : !l && t_forms__getMsg(_) && (l = t_forms__getMsg(_)), l && o && (s = o.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(s, (function (t) {
                t.innerHTML = l
            }))))
        }
    }
    ...
    document.body.insertAdjacentHTML("beforeend", n), window.removeEventListener("message", checkVerifyTildaCaptcha), window.addEventListener("message", checkVerifyTildaCaptcha), document.getElementById("tildaformcaptchabox").focus()
    ...
    var successBox = form.querySelector(".js-successbox"), successStr = t_forms__getMsg("success");
    if (successBox) {
                        ...
                        if (objData && objData.error) {
                            ...
                            if (window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics) {
                                ...
                                try {
                                    ...
                                    console.error("Error while sending statistics. Code status: ", t)
                                }
                                ...
                                try {
                                    ...
                                    console.error("Error while sending main metrica. Code status: ", t)
                                }
                                window.dataLayer && window.dataLayer.push({event: "submit_" + formId})
                            }
                            try {
                                ...
                                console.error("Error while call success callback. Code status: ", t)
                            }
        ...
        return xhr.open("POST", form.getAttribute("action"), !0), xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8"), xhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), xhr.onreadystatechange = function () {
            if (4 === xhr.readyState) if (xhr.status >= 200 && xhr.status < 400) {
                ...
                if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", o = xhr.responseText) if ("{" == o.substring(0, 1)) {
                    var a = JSON.parse(o);
                    if ("object" == typeof a) if (a && a.message && "OK" !== a.message) t.innerHTML = a.message; else if (a && a.error) {
                        var n,
                ...
                var l = "/tilda/" + formId + "/submitted/", c = "Send data from form " + formId;
    ...
    try {
        ...
        if (-1 !== t.toLowerCase().indexOf("utm_") && "string" == typeof (e = (e = (t = t.toLowerCase()).split("?"))[1])) {
            var o, a, n = e.split("&");
            for (a in n) "function" != typeof n[a] && "utm_" == (o = n[a].split("="))[0].substring(0, 4) && (r = r + n[a] + "|||");
    ...
    for (var e = Object(this), r = e.length >>> 0, o = arguments.length >= 2 ? arguments[1] : void 0, a = 0; a < r; a++) if (a in e && t.call(o, e[a], a, e)) return !0;
    return !1
}), function (t) {
    ...
    t.matches = t.matchesSelector = e || function t(e) {
        var t = document.querySelectorAll(e), r = this;
    ...
    var n = 0 | e;
    if (n >= a) return -1;
    for (r = Math.max(n >= 0 ? n : a - Math.abs(n), 0); r < a; r++) if (r in o && o[r] === t) return r;
    return -1
});
...
function t_serializeArray(t) {
    for (var e = [], r = t.querySelectorAll("input, textarea, button, select"), o = 0; o < r.length; o++) {
        ...
        if (!(!r[o].name || r[o].disabled || ["file", "reset", "submit", "button"].indexOf(r[o].type) > -1 || a && a.getAttribute("data-hidden-by-condition"))) if ("select-multiple" !== r[o].type) ["checkbox", "radio"].indexOf(r[o].type) > -1 && !r[o].checked || e.push({
            name: r[o].name,
            value: r[o].value
        }); else for (var n = r[o].options, i = 0; i < n.length; i++) n[i].selected && e.push({
            name: n[i].name,
            value: n[i].value
        })
    }
